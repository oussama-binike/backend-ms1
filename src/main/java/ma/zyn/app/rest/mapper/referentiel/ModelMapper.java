...
public class ModelMapper {
    ...
    public Model toItem(ModelDto dto) {
        if (dto == null) {
            return null;
        } else {
    ...
    public ModelDto toDto(Model item) {
        if (item == null) {
            return null;
        } else {
    ...
    public List<Model> toItem(List<ModelDto> dtos) {
    ...
    public List<ModelDto> toDto(List<Model> items) {
    ...
    public void copy(ModelDto dto, Model t) {
    ...
    public List<Model> copy(List<ModelDto> dtos) {
