...
@SpringBootTest
public class ConsommationSpecifiqueDaoTest {

@Autowired
    private ConsommationSpecifiqueDao underTest;
    ...
    void shouldFindByCode(){
        ...
        ConsommationSpecifique loaded = underTest.findByCode(code);
    ...
    void shouldFindById(){
        ...
        entity.setId(id);
        underTest.save(entity);
        ConsommationSpecifique loaded = underTest.findById(id).orElse(null);
    ...
    void shouldFindAll() {
        // Given
        List<ConsommationSpecifique> items = IntStream.rangeClosed(1, 10).mapToObj(i->constructSample(i)).collect(Collectors.toList());

        // Init
        items.forEach(underTest::save);

        // When
        List<ConsommationSpecifique> loadedItems = underTest.findAll();
    ...
    @Test
    void shouldSave(){
        ConsommationSpecifique given = constructSample(1);
        ConsommationSpecifique saved = underTest.save(given);
